  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, minHeight: 0, position: 'relative', overflowY: 'auto' }}>
        ...
        {q1Active && (
          <div style={{ display: 'flex', gap: '24px', height: '100%', padding: '24px', boxSizing: 'border-box' }}>
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '16px', height: '100%', minHeight: 0 }}>
              ...
              >
                <p style={{ color: '#94a3b8', margin: '0 0 10px 0', fontWeight: 700, fontSize: 'clamp(1.05rem, 1.2vw, 1.25rem)', fontFamily: '"Times New Roman", Times, Georgia, serif' }}>
                  {droppedCards.length === 0 ? "Drag or click activities from the left into this zone" : `Explored (${droppedCards.length}/${CARDS.length})`}
                </p>
                <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', justifyContent: 'center' }}>
                   {droppedCards.map(c => (
                      <div key={c.id} style={{ background: '#334155', border: '1px solid #475569', padding: '4px 12px', borderRadius: '20px', color: '#f8fafc', fontWeight: 800, fontSize: 'clamp(0.95rem, 1.05vw, 1.15rem)', display: 'flex', alignItems: 'center', gap: '6px' }}>
        ...
        {/* ═══════════════ QUESTION 2: REDESIGNED CLEAN 2-COLUMN LAYOUT FOR CLASS 6 ═══════════════ */}
        {!q1Active && (
          <div style={{
            flex: '1 0 auto',
            minHeight: '100%',
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <span style={{ fontSize: '1.9rem', lineHeight: 1.1, flexShrink: 0 }}>💡</span>
                  <p style={{
                    margin: 0,
              ...
              {/* ── RIGHT SIDE: CLEAN, CLASS-6-FRIENDLY MATHEMATICAL CONNECTIONS ── */}
              <div style={{
                display: 'flex',
                flexDirection: 'column',
                height: '100%',
                  ...
                  {Q2_ITEMS.map((item) => {
                    ...
                    return (
                      <div
                        ...
                        style={{
                          background: '#ffffff',
                          border: isSelected ? `2.5px solid ${item.accentColor}` : '2px solid #cbd5e1',
                          borderLeft: isSelected ? `8px solid ${item.accentColor}` : '3.5px solid #94a3b8',
                          borderRadius: '12px',
                          padding: '8px 16px',
                          cursor: 'pointer',
                          transition: 'all 0.18s cubic-bezier(0.16, 1, 0.3, 1)',
                          boxShadow: isSelected 
                            ? `0 6px 16px rgba(0,0,0,0.08), 0 0 0 1px ${item.accentColor}26` 
                      ...
                      >
                        <div style={{ display: 'flex', alignItems: 'center', gap: '14px', minWidth: 0 }}>
                          <span style={{ fontSize: '2.1rem', lineHeight: 1, flexShrink: 0 }}>
                            {item.emoji}
                          </span>
                ...
                <div style={{
                  ...
                  gap: '14px',
                  flexShrink: 0,
                  boxShadow: '0 3px 10px rgba(217, 119, 6, 0.16)'
                }}>
                  <span style={{ fontSize: '2rem', lineHeight: 1, flexShrink: 0 }}>💡</span>
                  <p style={{
                    margin: 0,
                    fontSize: 'clamp(1.28rem, 1.48vw, 1.75rem)',
                    fontWeight: 900,
                    color: '#78350f',
                    lineHeight: 1.3,
                    fontFamily: '"Times New Roman", Times, Georgia, serif'
                  }}>
                    “Mathematics turns ideas into real-world inventions.”
                  </p>
                </div>
