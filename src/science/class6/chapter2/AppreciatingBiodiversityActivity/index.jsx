      ...
      {phase === 'timer' ? (
        <div style={{
          ...
          <div style={{
            ...
            {/* Center: Textbook Title in Complementary Golden Amber (Activity 2.2: Let us appreciate) */}
            <div style={{
              display: 'flex',
              flexDirection: 'column',
              alignItems: 'center',
        ...
        <>
          ...
          <div style={{
            ...
            {/* ================================================================== */}
            {/* LEFT COLUMN: CLASS MEMORY WALL (Docx content alone)               */}
            {/* ================================================================== */}
