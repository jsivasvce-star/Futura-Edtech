...
import { Magnet, Compass, ArrowLeft, ArrowRight, CheckCircle, HelpCircle, Sparkles } from 'lucide-react';
...
const STEPS_NAV = [
  { id: 'magnetize', name: '1. Magnetize', icon: Magnet },
  { id: 'floating', name: '2. Make a Compass', icon: Compass },
...
export default function MagneticCompassActivity({ onBackToDashboard, onComplete }) {
  ...
  return (
    <div className="magnetic-compass-root" style={{ 
      position: 'fixed',
      top: 0,
      left: 0,
      width: '100vw', 
      ...
      <main style={{ 
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {stepIndex === 0 && <Stage1_Magnetize onComplete={handleStage1Complete} />}
            {stepIndex === 1 && <Stage2_Floating onComplete={handleStage2Complete} />}
