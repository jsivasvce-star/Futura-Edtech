...
import ch4_8_img from '../../../../assets/CH4_8.png';
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <img
          src={ch4_8_img}
          alt="Magnetic force through wood"
          style={{
            width: '100%',
            height: '100%',
            objectFit: 'cover',
        ...
        <div style={{
          ...
          <p style={{
            ...
            A magnet can exert its magnetic force through non-magnetic materials such as wood.<br />
            Even with a wooden barrier between them, the compass needle responds to the magnet.
          </p>
        </div>
      </div>
    </div>
