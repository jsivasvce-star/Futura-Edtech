...
const N_CLASSIC = {
  ...
  BK: { x: 740, y: 560, label: 'Bank', uniqueName: 'Bank', sub: 'Treasury & Forex', type: 'bank', goal: true, icon: '🏦' },
...
const N_3D = {
  ...
  BK: { x: 657, y: 368, label: 'Bank', uniqueName: 'Bank', sub: 'Treasury & Forex', type: 'bank', goal: true, icon: '🏦' },
...
const BUILDING_BADGES_3D = [
  ...
  { id: 'b_bk', type: 'bank', name: 'Bank', icon: '🏦', x: 660, y: 235 },
