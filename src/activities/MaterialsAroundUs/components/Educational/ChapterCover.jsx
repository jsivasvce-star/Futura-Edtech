      ...
      <div style={{
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', position: 'relative', width: '100%' }}>
            <h1 className="text-dark-blue" style={{ 
              fontSize: 'min(7vw, 10vh)', 
              fontWeight: 900, 
              margin: 0, 
              lineHeight: 1, 
            ...
            <div className="text-dark-blue text-outline-pill" style={{ 
              ...
              marginTop: '1.5vh',
              alignSelf: 'flex-end',
              marginRight: '8%' // Tuck it under 'Lab'
            }}>
              class 6 - science
            </div>
          </div>
          ...
          {/* Bullet Points */}
          <div style={{ marginTop: '5vh', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '2vh' }}>
            <div style={{ color: '#518ac9', fontSize: '24px', fontWeight: 800, letterSpacing: '0.05em', display: 'flex', gap: '2vw', alignItems: 'center' }}>
              <span>SORTING</span>
              <div style={{ width: '8px', height: '8px', borderRadius: '50%', backgroundColor: '#518ac9' }}></div>
