...
export default function Quiz({ onComplete }) {
  ...
  if (isFinished) {
    return (
      <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', overflowY: 'auto', padding: '1rem', boxSizing: 'border-box', fontFamily: "'Inter', sans-serif", borderRadius: '24px', border: '1.5px solid #FDE68A', background: 'linear-gradient(135deg, #FFFBEB 0%, #FEF3C7 100%)', boxShadow: '0 8px 24px rgba(217, 119, 6, 0.08)' }}>
        <div style={{ 
          maxWidth: '620px', 
          width: '90%', 
          padding: '3rem 3.5rem', 
