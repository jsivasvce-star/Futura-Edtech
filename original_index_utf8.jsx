...
const MYSTERY_PLANTS = [
  {
    ...
    bendResult: {
      angle: 48,
      bubble: '≡ƒîƒ Boing! Super soft & flexible ΓÇö bends 48┬░ easily without cracking!',
      color: '#10B981',
      badge: 'Soft & Tender Stem'
    },
    heightResult: {
      desc: 'Only 0.4 m tall (Below knee) ΓÇö Much shorter than a 6th grader (< 1 m)',
  ...
  },
  {
    ...
    bendResult: {
      angle: 18,
      bubble: 'ΓÜá∩╕Å Creeeak! Stiff & woody ΓÇö resists bending and stops at 18┬░!',
      color: '#F59E0B',
      badge: 'Stiff Woody Stem'
    },
    heightResult: {
      desc: '1.6 m tall (Eye level) ΓÇö About the same height as a 6th grader (1 ΓÇô 2.5 m)',
  ...
  },
  {
    ...
    bendResult: {
      angle: 0,
      bubble: '≡ƒ¢æ Clunk! Rock solid ΓÇö 0┬░ deflection! Human hands cannot bend a giant trunk!',
      color: '#DC2626',
      badge: 'Rigid Massive Trunk'
    },
    heightResult: {
      desc: '12.0 m tall ΓÇö Towers 8 times taller than a 6th grader (> 5 m)!',
...
const CLUE_OPTIONS = {
  stem: [
    { label: '≡ƒî┐ Soft & Green', idx: 0 },
    { label: '≡ƒ¬╡ Thin Woody', idx: 1 },
    { label: '≡ƒî▓ Thick Trunk', idx: 2 }
  ],
  branch: [
    { label: '≡ƒìâ Few / None', idx: 0 },
    { label: '≡ƒî▒ Near Base', idx: 1 },
    { label: '≡ƒî│ High Above', idx: 2 }
  ],
  flex: [
    { label: '≡ƒî┐ Soft & Flexible', idx: 0 },
    { label: '≡ƒ¬╡ Stiff (Resists)', idx: 1 },
    { label: '≡ƒî▓ Rigid (Zero Bend)', idx: 2 }
  ]
};
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              <div style={{
                ...
                Γ£ª αñ╕αñ░αÑìαñ╡αñ¡αÑéαññαñ╣αñ┐αññαÑç αñ░αññαñ╛αñâ ┬╖ Herbs, Shrubs, and Trees Laboratory Γ£ª
              </div>
            </div>
                ...
                >
                  <div style={{ display: 'flex', flexDirection: 'column', minHeight: 0, gap: '5px' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                        ...
                        <span style={{
                          ...
                          {isSolved ? 'Γ£ô SOLVED' : 'ΓùÅ UNRESOLVED'}
                        </span>
                      </div>
                    </div>
                    ...
                    <div style={{
                      ...
                      <span style={{ position: 'absolute', top: '27px', left: '8px', fontSize: '18px', lineHeight: 1, color: '#059669', fontWeight: '900', userSelect: 'none' }}>Γî£</span>
                      <span style={{ position: 'absolute', top: '27px', right: '8px', fontSize: '18px', lineHeight: 1, color: '#059669', fontWeight: '900', userSelect: 'none' }}>Γî¥</span>
                      <span style={{ position: 'absolute', bottom: '6px', left: '8px', fontSize: '18px', lineHeight: 1, color: '#059669', fontWeight: '900', userSelect: 'none' }}>Γî₧</span>
                      <span style={{ position: 'absolute', bottom: '6px', right: '8px', fontSize: '18px', lineHeight: 1, color: '#059669', fontWeight: '900', userSelect: 'none' }}>Γîƒ</span>
                    ...
                    <div style={{
                      ...
                      <div style={{
                        ...
                        <span style={{ color: '#475569', display: 'flex', alignItems: 'center', gap: '5px' }}>
                          <span style={{ color: '#059669' }}>≡ƒî┐</span> Stem:
                        </span>
                      ...
                      <div style={{
                        ...
                        <span style={{ color: '#475569', display: 'flex', alignItems: 'center', gap: '5px' }}>
                          <span style={{ color: '#D97706' }}>≡ƒî│</span> Branches:
                        </span>
                      ...
                      <div style={{
                        ...
                        <span style={{ color: '#475569', display: 'flex', alignItems: 'center', gap: '5px' }}>
                          <span style={{ color: '#2563EB' }}>≡ƒôÅ</span> Height:
                        </span>
                    ...
                    <div style={{
                      ...
                      <span style={{ fontSize: '16px', fontWeight: '800', color: '#F8FAFC', display: 'flex', alignItems: 'center', gap: '6px' }}>
                        <span>≡ƒö¼</span> Classification Target:
                      </span>
                      <span style={{
                        fontSize: '16px',
                        fontWeight: '900',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              {isCaseSolved ? (
                ...
                <div style={{
                  ...
                  ≡ƒò╡∩╕ÅΓÇìΓÖé∩╕Å Active Investigation
                </div>
              )}
                      ...
                      >
                        ...
                        <div style={{
                          ...
                          <div style={{
                            ...
                            <span style={{ fontSize: '16px', fontWeight: '900', color: '#FED7AA' }}>≡ƒî▒ Root Ball</span>
                          </div>
                  ...
                  {activeTool === 'loupe' && (
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%', gap: '12px' }}>
                      ...
                      <span style={{ fontSize: '16px', color: '#059669', fontWeight: '800' }}>
                        Γ£¿ Tip: Drag the lens freely over any part of the plant!
                      </span>
                    </div>
                  )}
                  ...
                  {activeTool === 'bend' && (
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%', gap: '14px' }}>
                      ...
                      <span style={{ fontSize: '16px', color: '#059669', fontWeight: '800', whiteSpace: 'nowrap' }}>
                        Γ£¿ Tip: Drag stem or use buttons!
                      </span>
                    </div>
                  )}
                </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '6px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    <span style={{ fontSize: '18px' }}>≡ƒÆí</span>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  {currentAnswers.stem !== null && <span style={{ fontSize: '16px', color: '#059669', fontWeight: '900' }}>Γ£ô Logged</span>}
                </div>
                <div style={{ display: 'flex', gap: '6px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  {currentAnswers.branch !== null && <span style={{ fontSize: '16px', color: '#059669', fontWeight: '900' }}>Γ£ô Logged</span>}
                </div>
                <div style={{ display: 'flex', gap: '6px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  {currentAnswers.flex !== null && <span style={{ fontSize: '16px', color: '#059669', fontWeight: '900' }}>Γ£ô Logged</span>}
                </div>
                <div style={{ display: 'flex', gap: '6px' }}>
              ...
              <div style={{
                ...
                {isCaseSolved ? (
                  <div style={{
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <span style={{ fontSize: '16px', fontWeight: '900' }}>Γÿà CASE CRACKED: {activePlant.category.toUpperCase()}!</span>
                      <span style={{ fontSize: '16px' }}>Γ£ô</span>
                    </div>
                  ...
                  <div style={{ display: 'flex', gap: '6px' }}>
                    {[
                      { cat: 'Herb', label: '≡ƒî┐ HERB', color: '#10B981' },
                      { cat: 'Shrub', label: '≡ƒî║ SHRUB', color: '#F59E0B' },
                      { cat: 'Tree', label: '≡ƒî│ TREE', color: '#059669' }
                    ].map(item => (
                      <button
                        key={item.cat}
                ...
                {currentAnswers.category && !isCaseSolved && (
                  <div style={{
                    ...
                    Γ¥î Clues don't match! Try checking the Stem Bend test on the left!
                  </div>
                )}
              </div>
            </div>
